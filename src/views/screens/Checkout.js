...
const showAlert = ({navigation}) =>
  Alert.alert(
    "Payment Succesful",
    "Congratulations!! You have successfully made payment.",
    [
      {
        text: "Done",
...
function Checkout({navigation}) {
    ...
    return (
        ...
        <View style={styles.Checkout}>
            ...
            <Image source={require('C:\Users\USER\Desktop\202-IA\src\assets')} style={styles.imgStylenew}  />
            ...
            <View style={styles.categories}>
                ...
                <View>
                <Text style={{fontSize:25,paddingTop:37,paddingLeft:20, fontWeight:'bold', color:COLORS.dark,}}> $2000.00 </Text>
                </View>
            ...
            <Text 
            style={{color:"white", fontSize:20, fontWeight: 'bold', textAlign:'center',}}>Make Payment</Text> 
            </TouchableOpacity>
